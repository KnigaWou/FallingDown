...
let frameDelay = 10;      // СКОЛЬЖЕНИЕ: кадр меняется каждые 30 циклов (медленно)
let fastFrameDelay = 3;   // ПАДЕНИЕ: максимальная скорость — каждые 5 циклов (быстро)
let maxSpeedFrames = 20;  // Через 50 циклов падения достигаем максимальной скорости
